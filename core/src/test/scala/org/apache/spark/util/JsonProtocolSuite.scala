...
class JsonProtocolSuite extends SparkFunSuite {
  ...
  test("Dependent Classes") {
    ...
    val fetchFailed = FetchFailed(
      BlockManagerId("With or", "without you", 15), 17, 18, 19, 20, "Some exception")
  ...
  test("FetchFailed backwards compatibility") {
    ...
    val expectedFetchFailed = FetchFailed(BlockManagerId("With or", "without you", 15),
      17, 18, 19, 20, "Unknown reason")
